      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="mt-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    ...
                    <button className="text-sky-700 hover:text-sky-800 font-medium">管理目录</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'template-based' && (
            <div>
              <div className="flex items-center mb-4">
                <Settings className="w-6 h-6 text-sky-600 mr-2" />
                <h2 className="text-lg font-semibold">基于投标模板</h2>
              </div>
              <p className="text-gray-600 mb-6">选择预设的投标模板创建投标文件目录，可手动选择标书类型。</p>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                <div className="border border-gray-200 rounded-lg p-4 hover:border-sky-400 transition-colors cursor-pointer">
                ...
                <div className="border border-gray-200 rounded-lg p-4 hover:border-sky-400 transition-colors cursor-pointer">
                  ...
                  <span className="inline-block bg-sky-100 text-sky-800 text-xs px-2 py-1 rounded">服务类</span>
                </div>
              </div>
          ...
          {activeTab === 'custom-create' && (
            <div>
              <div className="flex items-center mb-4">
                <Plus className="w-6 h-6 text-sky-600 mr-2" />
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-600 focus:border-transparent"
                    placeholder="请输入项目名称"
                  />
                </div>
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-600 focus:border-transparent">
