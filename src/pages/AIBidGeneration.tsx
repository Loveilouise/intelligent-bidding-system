...
import { Upload, FileText, Settings, Play, Download, Eye, Sparkles, Clock, CheckCircle } from 'lucide-react';
...
const AIBidGeneration: React.FC = () => {
  ...
  const steps = [
    { id: 1, title: '项目信息', description: '填写基本项目信息' },
    { id: 2, title: '文件上传', description: '上传招标相关文件' },
    { id: 3, title: 'AI配置', description: '配置生成参数' },
    { id: 4, title: '生成标书', description: 'AI智能生成投标文件' }
  ];
          ...
          <div className="space-y-6">
            {generationStatus === 'idle' && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 mb-6">AI将根据您提供的信息和配置智能生成专业的投标文件</p>
